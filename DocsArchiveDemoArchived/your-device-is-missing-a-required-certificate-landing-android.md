...
The first step you should try is to see if your device is [missing a certificate that usually comes preinstalled on it](https://review.docs.microsoft.com/DocsArchiveDemoSrc/your-device-is-missing-a-preinstalled-certificate-android).

If this doesn't work, your IT admin could [require you to install a second certificate for additional security](https://review.docs.microsoft.com/DocsArchiveDemoSrc/your-device-is-missing-an-IT-required-certificate-android).
